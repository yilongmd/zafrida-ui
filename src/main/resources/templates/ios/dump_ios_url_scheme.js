// Intercept openURL (URL Schemes) (拦截 openURL - URL Scheme 调用)
// Hook UIApplication -openURL: to log outgoing URL scheme invocations. (钩住 UIApplication openURL 方法，记录外发的 URL Scheme 调用)
